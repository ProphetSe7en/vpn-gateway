...
// the main VPN Gateway UI for visual consistency.
...
<head>
<meta charset="utf-8">
<title>VPN Gateway — First-run setup</title>
...
<body>
<div class="card">
  <h1>Welcome to VPN Gateway</h1>
  <p class="sub">Authentication is now required. Create the admin account to continue — you'll use this login every time you access VPN Gateway from outside your local network.</p>
  ...
  <footer>VPN Gateway {{.Version}} · security · <a href="https://github.com/ProphetSe7en/vpn-gateway" style="color:#4a90e2;text-decoration:none">github</a></footer>
</div>
</body>
</html>`))
...
<div class="card">
  ...
  <footer>VPN Gateway {{.Version}}</footer>
</div>
</body>
</html>`))
