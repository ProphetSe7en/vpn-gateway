...
**Latest version: `v1.4.5`** — [all tags](https://github.com/prophetse7en/vpn-gateway/pkgs/container/vpn-gateway)

```bash
docker pull ghcr.io/prophetse7en/vpn-gateway:v1.4.5
```
...
docker run -d \
  ...
  ghcr.io/prophetse7en/vpn-gateway:v1.4.5
```
...
**Or install manually:** Go to **Docker** → **Add Container**, set Repository to `ghcr.io/prophetse7en/vpn-gateway:v1.4.5`, and add the required paths, ports, and capabilities (see above).
